  ...
  is_good(str){
    ...
    render() {
        ...
        return (
                ...
                <DateTimeInput validation = {this.is_good(parms.p2)} format="YYYY-MM-DD" addonBefore={iconUser} addonAfter='必填' label="毕业典礼时间" dateTime= {parms.p2} onSelect={(e)=>{parms['p2'] = e ;this.setState({parms:parms})}}/>
