  ...
  validation_all(){
    ...
    render() {
        ...
        return (
                ...
                <DateTimeInput format="YYYY-MM-DD" addonBefore={iconUser} addonAfter='必填' label="典礼日期" dateTime= {parms.p5} onSelect={(e)=>{parms['p5'] = e ;this.setState({parms:parms})}}validation = {this.is_good(parms.p5)}/>
